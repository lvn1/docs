...
export const IconDeepDive = ({ ...rest }) => {
  return (
    <Icon
      {...rest}
      viewBox={{
    ...
    >
      ...
      />
      <path
        d="M19.2212 10.6814L19.2212 14.7434H23.4159V18.5664H19.2212V22.6283H15.3982V18.5664H11.469V14.7434L15.3982 14.7434V10.6814H19.2212Z"
        fill="currentColor"
      />
    </Icon>
  );
